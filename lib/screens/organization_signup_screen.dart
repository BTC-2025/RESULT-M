...
class OrganizationSignupScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<OrganizationSignupScreen> createState() => _OrganizationSignupScreenState();
}

class _OrganizationSignupScreenState extends ConsumerState<OrganizationSignupScreen> with SingleTickerProviderStateMixin {
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Hero(
                      tag: 'auth_icon_org',
                      child: Icon(Icons.business_center, size: 64, color: context.colors.orange),
                    ),
                    const SizedBox(height: 24),
                    Text(
                      'Organization Signup',
                              ...
                              Container(
                                ...
                                child: DropdownButtonHideUnderline(
                                  child: DropdownButton<String>(
                                    ...
                                    icon: Icon(Icons.arrow_drop_down, color: context.colors.inkMuted),
