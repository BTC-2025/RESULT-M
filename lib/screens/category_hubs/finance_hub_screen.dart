    ...
    return Scaffold(
      ...
      body: NestedScrollView(
            ...
            flexibleSpace: FlexibleSpaceBar(
              background: Container(
                ...
                child: Padding(
                  ...
                  child: Row(children: [
                    const Expanded(child: _Chip('NSE', 'Market Open')),
                    const SizedBox(width: 10),
                    const Expanded(child: _Chip('24,852', 'Nifty 50')),
                    const SizedBox(width: 10),
                    const Expanded(child: _Chip('+1.2%', 'Today')),
                  ]),
                ),
              ),
            ),
        ...
        body: TabBarView(
          controller: _tabController,
          children: const [
            DomainDatasetsTab(domainType: 'FINANCE', themeColor: Color(0xFF059669)),
            SharedOrganizationsTab(domainType: 'FINANCE', themeColor: Color(0xFF059669)),
          ],
        ),
      ),
    );
