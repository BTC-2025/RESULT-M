    ...
    return Scaffold(
      ...
      body: NestedScrollView(
            ...
            flexibleSpace: FlexibleSpaceBar(
              background: Container(
                ...
                child: Padding(
                  ...
                  child: Row(children: [
                    const Expanded(child: _Chip('3,500+', 'Hospitals')),
                    const SizedBox(width: 10),
                    const Expanded(child: _Chip('Medical', 'Board Results')),
                    const SizedBox(width: 10),
                    const Expanded(child: _Chip('Public', 'Health Data')),
                  ]),
                ),
              ),
            ),
        ...
        body: TabBarView(
          controller: _tabController,
          children: const [
            DomainDatasetsTab(domainType: 'HEALTHCARE', themeColor: Color(0xFFDC2626)),
            SharedOrganizationsTab(domainType: 'HEALTHCARE', themeColor: Color(0xFFDC2626)),
          ],
        ),
      ),
    );
