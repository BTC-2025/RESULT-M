    ...
    return Scaffold(
      ...
      body: NestedScrollView(
            ...
            flexibleSpace: FlexibleSpaceBar(
              background: Container(
                ...
                child: Padding(
                  ...
                  child: Row(children: [
                    const Expanded(child: _Chip('Your', 'Community')),
                    const SizedBox(width: 10),
                    const Expanded(child: _Chip('Local', 'Events')),
                    const SizedBox(width: 10),
                    const Expanded(child: _Chip('Private', 'Accessible')),
                  ]),
                ),
              ),
            ),
        ...
        body: TabBarView(
          controller: _tabController,
          children: const [
            DomainDatasetsTab(domainType: 'HYPERLOCAL', themeColor: Color(0xFF10B981)),
            SharedOrganizationsTab(domainType: 'HYPERLOCAL', themeColor: Color(0xFF10B981)),
          ],
        ),
      ),
    );
