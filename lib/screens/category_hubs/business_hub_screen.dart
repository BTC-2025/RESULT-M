    ...
    return Scaffold(
      ...
      body: NestedScrollView(
            ...
            flexibleSpace: FlexibleSpaceBar(
              background: Container(
                ...
                child: Padding(
                  ...
                  child: Row(children: [
                    const Expanded(child: _Chip('4.2M+', 'Jobs Listed')),
                    const SizedBox(width: 10),
                    const Expanded(child: _Chip('12K+', 'Companies')),
                    const SizedBox(width: 10),
                    const Expanded(child: _Chip('Placement', 'Results')),
                  ]),
                ),
              ),
            ),
        ...
        body: TabBarView(
          controller: _tabController,
          children: const [
            DomainDatasetsTab(domainType: 'BUSINESS', themeColor: Color(0xFFF97316)),
            SharedOrganizationsTab(domainType: 'BUSINESS', themeColor: Color(0xFFF97316)),
          ],
        ),
      ),
    );
