...
class _CreateOrganizationScreenState
  ...
  bool get _canContinue {
    switch (_step) {
      ...
      case 3: return _visibility != 'PASSWORD' || _accessCodeController.text.trim().length == 6;
      case 4: return true;
      case 5: return true;
      default: return true;
    }
  ...
  Future<void> _handleCreate() async {
    ...
    try {
      ...
      final payload = <String, dynamic>{
        ...
        'visibility': _visibility == 'PASSWORD' ? 'PASSWORD_PROTECTED' : _visibility,
      };
      
      if (_visibility == 'PASSWORD') {
        payload['accessCode'] = _accessCodeController.text.trim();
      }
      if (_logoBase64 != null) {
        payload['logoBase64'] = _logoBase64;
      } else {
        payload['logoEmoji'] = _logoEmoji;
      }
      ...
      showDialog(
        ...
        builder: (ctx) => AlertDialog(
          ...
          title: Row(
            children: [
              Icon(Icons.error_outline_rounded, color: context.colors.liveRed),
      ...
      children: [
        ...
        if (_visibility == 'PASSWORD') ...[
          ...
          TextField(
            ...
            decoration: InputDecoration(
              hintText: 'Enter a 6-character passcode',
              hintStyle: TextStyle(color: context.colors.inkFaint),
              filled: true,
              fillColor: context.colors.surface,
              border: OutlineInputBorder(
  ...
  Widget _buildLogoStep() {
    ...
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 8),
        Text('Pick an emoji or upload a custom brand image logo.', style: TextStyle(
          color: context.colors.inkMuted, height: 1.5,
        )),
        const SizedBox(height: 24),
        Center(
            ...
            child: ClipRRect(
              ...
              child: _logoBase64 != null
                  ? Image.memory(
                      ...
                      fit: BoxFit.cover,
                      width: 100, height: 100,
                      errorBuilder: (c, e, s) => Center(child: Icon(Icons.broken_image, color: context.colors.inkMuted)),
                    )
                  : Center(child: Text(_logoEmoji, style: const TextStyle(fontSize: 48))),
            ),
          ),
        ),
        const SizedBox(height: 24),
        ...
        GridView.builder(
          ...
          itemBuilder: (context, i) {
            final isSelected = _logoEmoji == emojis[i] && _logoBase64 == null;
            return GestureDetector(
              onTap: () => setState(() {
                _logoEmoji = emojis[i];
                _logoBase64 = null;
              ...
              child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(
                    color: isSelected ? context.colors.orange : context.colors.border,
                    width: isSelected ? 2 : 1,
                  ),
                ),
                ...
                ClipRRect(
                  ...
                  child: _logoBase64 != null
                      ? Image.memory(
                          ...
                          fit: BoxFit.cover,
                          width: 36, height: 36,
                          errorBuilder: (c, e, s) => Icon(Icons.broken_image, color: context.colors.inkMuted),
                        )
